...
type TestMessage struct {
	...
	TextM  string `protobuf:"bytes,1,opt,name=textM,proto3" json:"textM,omitempty"`
	TextML string `protobuf:"bytes,2,opt,name=textML,proto3" json:"textML,omitempty"`
...
func (x *TestMessage) GetTextM() string {
	if x != nil {
		return x.TextM
	}
	return ""
...
func (x *TestMessage) GetTextML() string {
	if x != nil {
		return x.TextML
	}
	return ""
...
var file_proto_test_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x4b, 0x0a, 0x0b, 0x54, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x65, 0x78, 0x74, 0x4d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x74, 0x65, 0x78, 0x74, 0x4d, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x65, 0x78, 0x74, 0x4d,
	0x4c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x65, 0x78, 0x74, 0x4d, 0x4c, 0x12,
...
var file_proto_test_proto_goTypes = []interface{}{
	(*TestMessage)(nil), // 0: pixalquarks.terminalChatServer.TestMessage
}
